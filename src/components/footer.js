...
function Footer({notification}) {
    ...
    return (
        ...
        <footer class="w-full h-auto bg-nblue relative overflow-hidden">
            <div className={notification ? "lg:absolute static -top-12 w-full h-auto lg:px-20 px-2 flex lg:flex-row flex-col gap-4":"lg:absolute static -top-12 w-full h-auto lg:px-20 px-2 flex lg:flex-row flex-col gap-4 hidden"}>
                <div class="lg:w-1/4 w-full h-auto px-4 py-2 bg-lgreen border-2 shadow-lg border-green rounded-2xl flex gap-2 items-center">
                    ...
                    <div class="h-auto flex flex-col justify-between">
                        <h3 class="text-mont text-sm text-lblack font-bold">We’ve Ready!</h3>
                        <p class="text-mont text-xs text-l2black">Your donation has been added to checkout and is ready the moment you are. Thanks so much for joining us in making a difference.</p>
                    </div>
                </div>
                <div class="lg:w-1/4 w-full h-auto px-4 py-2 bg-orange border-2 shadow-lg border-orange rounded-2xl flex gap-2 items-center">
                    ...
                    <div class="h-auto flex flex-col justify-between">
                        <h3 class="text-mont text-sm text-lblack font-bold">Oh no, there’s Bug!</h3>
                ...
                <div class="lg:w-1/4 w-full h-auto px-4 py-2 py-2 bg-white border-2 shadow-lg border-gray-400 rounded-2xl flex gap-2 items-start">
                    ...
                    <div class="h-auto flex flex-col justify-between">
                        <h3 class="text-mont text-sm text-lblack font-bold">Can we use Cookies?</h3>
                        <p class="text-mont text-xs text-l2black w-4/5 my-2">They help our site run at 100% efficiency but you can opt out.</p>
                        <button class="w-3/5 px-4 py-2 bg-sblue rounded-lg text-center text-mont text-sm text-white font-bold">CLICK HERE</button>
                    </div>
                </div>
            </div>
            <div class="w-full h-auto px-5 pt-24 pb-8 container mx-auto relative">
                <div class="w-full h-auto">
                    <p class="text-footer text-mont text-xs">Aid Humanity is a UK registered charity 1184639.</p>
                </div>
                <div class="w-full h-auto mt-4 flex lg:flex-row flex-col lg:gap-10 gap-5 justify-between items-center">
                    <div class="lg:w-1/3 w-full h-auto py-4">
                        <div class="w-full h-auto flex items-center justify-between">
                            ...
                            <div class="px-4">
                                ...
                                <p class="text-mont text-fyellow lg:text-lg text-xs font-semibold mt-4">info@aidhumanity.co.uk</p>
                        ...
                        <div class="w-full h-auto mt-8">
                            <p class="text-base text-mont text-footer">Aid Humanity is proud to be a non-profit organization that passes 100% of our donations to charitable -top-1/4 around the world.</p>
                        </div>
                    ...
                    <div class="lg:w-1/3 w-full h-auto">
                        ...
                        <h1 class="text-white text-lg text-mont font-bold mt-4 lg:w-4/5 w-full">Subscribe to the free newsletter and stay up to date</h1>
                        <form class="w-full h-auto flex items-center mt-4 gap-4" action="">
                            <input class="lg:w-3/5 w-4/5 h-auto bg-white text-gray text-sm text-mont p-3 border-2 rounded-lg z-10 focus:outline-none" type="text" name="" id="" placeholder="Your email" />
                            <button class="bg-sblue rounded-lg py-3 px-5 text-white"><i class="fa-solid fa-arrow-right z-10"></i></button>
                        </form>
                ...
                <svg className='absolute w-2/5 -right-20 -top-6 z-0'  xmlns="http://www.w3.org/2000/svg" width="565.582" height="756.5" viewBox="0 0 465.582 606.5">
