...
function Appeal_share({ showModal, setshowModal }) {
  return (
    <div className='modal'>
      ...
      <div class="messageBox lg:w-650 w-full lg:h-auto h-screen bg-white flex lg:flex-row flex-col-reverse lg:justify-between justify-end gap-2 px-6 py-8 lg:rounded-2xl">
