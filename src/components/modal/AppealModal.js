const AppealModal = ({ showModal, setshowModal, active }) => {
  return (
      ...
      <div class="w-full lg:h-auto h-full relative">
        <div class="w-full lg:h-auto h-full rounded-t-2xl">
            ...
            {active == 'appeal' || active == 'zakat' ? (
              <div class="lg:w-1/3 w-full h-auto flex justify-between">
                ...
                <div class="w-full h-auto ml-4 flex flex-col">
                  <a class="text-nblue text-mont text-lg font-bold" href="">
                    Build a Mosque
                  </a>
                  <a
                    class="text-base text-dgray tet-mont font-medium mt-4"
                    href=""
                  >
                    Pay for a Brick
                  </a>
                  <a
                    class="text-base text-dgray tet-mont font-medium mt-2"
                    href=""
                  >
                    Books
                  </a>
          ...
          <div class="w-full h-auto rounded-b-2xl p-10 bg-gray lg:flex justify-between hidden">
            ...
            <div class="w-1/4 h-auto px-4 flex justify-center">
              <div class="w-1/2 h-auto relative">
                <img
                  ...
                  src="./images/Pakistan Floods 2022 horizontal.png"
            ...
            <div class="w-1/4 h-auto px-4 flex justify-center">
              <div class="w-1/2 h-auto relative">
                <img
                  className="w-full h-full"
                  src="./images/maxresdefault horizontal.png"
                  alt="maxresdefault"
                />
                <button
                  id="cursor-pointer"
              ...
              <div class="w-1/2 h-auto bg-white rounded-r-xl flex flex-col justify-between relative p-4">
                <h2 class="text-xs text-mont font-bold text-black-50">
                  Support <br /> an Orphaned <br /> Child
                </h2>
                <a class="text-sblue text-lg" href="">
                  <i class="fa-solid fa-arrow-right"></i>
                </a>
            ...
            <div class="w-1/4 h-auto px-4 flex justify-center">
              <div class="w-1/2 h-auto relative">
                <img
                  className="w-full h-full"
                  src="./images/rf1110721-somali-refugee-family-in-yemen-1200x800-images horizontal.png"
          ...
          <img
            class={
              active == 'appeal'
                ? 'absolute -top-2 left-1/4 ml-4 hidden lg:block'
                : active == 'zakat'
                ? 'absolute -top-2 left-1/2  -ml-10  hidden lg:block'
                : 'absolute -top-2 left-1/3 ml-10  hidden lg:block'
            }
