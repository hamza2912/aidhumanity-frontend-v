    ...
    <div className="w-full left-0 top-full h-auto z-50 lg:absolute fixed lg:shadow-xl">
      ...
      <div className="w-full lg:h-auto h-full relative">
        <div className="w-full lg:h-auto h-full rounded-t-2xl">
          {active === 'zakat' && (
            <div className="w-full h-auto lg:px-20 lg:py-6 p-5 relative lg:rounded-t-2xl bg-bwhite flex lg:flex-row flex-col justify-between items-center">
              <img
              ...
              <div className="lg:w-2/3 w-full mt-4 lg:mt-0 h-auto flex lg:flex-row flex-col gap-4 lg:gap-0 justify-between items-center">
                <div className="lg:w-1/3 w-full border-2 border-l2black rounded-xl py-2 px-3">
          ...
          <div
            className={
              active !== 'zakat'
                ? 'w-full lg:h-auto h-screen lg:rounded-t-2xl px-12 py-10 relative bg-rwhite flex lg:flex-row flex-col gap-4 lg:justify-between overflow-hidden'
            ...
            <div className="w-3/4 flex gap-6">
              {popularDonations.slice(0, 3).map((appeal, index) => (
                ...
                >
                  ...
                  <div className="w-1/2 h-auto bg-white flex flex-col justify-between relative p-7 rounded-r-2xl">
