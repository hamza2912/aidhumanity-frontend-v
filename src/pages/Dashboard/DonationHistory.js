            ...
            <div className="bg-white rounded-xl w-full lg:px-6 px-4 py-8 ">
              ...
              <div className="flex justify-between mt-6 items-center">
                ...
                <div className="flex gap-2 w-auto">
                  <button className="border-2 border-gray-200 bg-gray text-gray-400 py-2 px-4 font-semibold text-sm rounded-lg z-10 prev">
                    PREVIOUS
                  </button>
                  <button className="border-2 border-gray-200 text-gray-400 py-2 px-4 font-semibold text-sm rounded-lg z-10 next">
                    NEXT
                  </button>
                </div>
              </div>
