  ...
  return (
    ...
    <div class="lg:w-1/5 w-11/12 h-auto bg-sblue"> 
                ...
                <div class="w-full h-auto p-4">
                    <h2 class="text-mont text-xl text-white font-bold">Jummah Giving</h2>
                    <p class="text-mont text-sm text-white mt-4">Jummah Giving is an amazing opportunity to maximise the Blessings of Jummah.</p>
                    <div class="w-full h-auto p-4 bg-white rounded-2xl mt-6">
                        ...
                        <button class="mt-2 w-full h-auto flex items-center gap-4 text-mont text-sm text-l3black font-medium"><input type="radio" id="html" name="fav_language" value="HTML" /><img src="./Icons/icon_education.svg" alt="icon_education" />Qur’an</button>
                        <button class="mt-2 w-full h-auto flex items-center gap-4 text-mont text-sm text-l3black font-medium"><input type="radio" id="html" name="fav_language" value="HTML" /><img src="./Icons/icon_hungry.svg" alt="icon_hungry" />Food</button>
                        ...
                        <div class="relative">
                            <label class="text-mont text-dgray text-xs font-medium absolute left-2 top-2">Number of Fridays</label>
