...
import Cancel_modal from '../../components/modal/CancelModal';
        ...
        <div className="lg:w-3/5 w-full page-section mx-auto">
          ...
          <div className="bg-white lg:px-6 px-4 py-8 border-b-2">
            <p className="text-gray-600 mt-4">
              Your page will stop taking donations on{' '}
              <span className="font-semibold">08 March 2023</span>
            </p>
          ...
          <div className="bg-white w-full border-b-2">
            <div className="lg:px-6 px-4 py-8">
              ...
              <img
                ...
                src="images/icons/dashboard/QR.png"
                alt=""
              />
            </div>
          </div>
