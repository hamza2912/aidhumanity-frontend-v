        ...
        <section class="w-full h-auto px-5 container mx-auto mt-12">
          ...
          <div class="w-full h-auto flex lg:flex-row flex-col justify-between lg:py-16 py-4">
            <div class="lg:w-2/3 w-full h-auto">
              <h1 class="text-black-50 text-left lg:text-4xl text-3xl text-mont font-bold">
                Terms & Conditions
              </h1>
              <p class="text-lg text-mont text-gray-600 mt-4">
                Please read the following carefully
              </p>
              <h3 class="text-lg text-mont text-gray-600 font-semibold mt-8">
                Aid Humanity
              </h3>
              ...
              <ul class="pl-8 pt-4 terms">
                <li class="text-lg text-mont text-gray-600 mt-4">
