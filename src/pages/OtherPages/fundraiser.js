    ...
    <>
      ...
      <main>
        <div class="w-full h-auto py-8 bg-bwhite">
          <h1 class="lg:text-3xl text-2xl text-mont text-black-50 font-bold flex items-center justify-center">
            Become a Fundraiser
          </h1>
        </div>
        <section class="w-full h-auto mt-12">
          ...
          <div class="w-full h-auto lg:pl-5 container mx-auto p-4 lg:p-0 flex lg:flex-row flex-col items-center lg:items-start lg:justify-between justify-center lg:py-16 py-0  mt-2 relative">
            <div class="w-full lg:w-1/2 h-auto lg:pr-4 pr-0">
              <h1 class="text-black-50 lg:text-start text-4xl text-mont font-bold">
                Become a Fundraiser
              </h1>
            ...
            <div class="w-full lg:w-1/2 h-auto flex flex-col lg:justify-end items-end">
              ...
              <div class="w-full h-auto mt-8 flex justify-center">
                <button class="w-full lg:w-auto text-white text-mont text-xs font-semibold rounded-lg text-center px-10 py-3 bg-sblue">
                  CREATE AN ACCOUNT
                </button>
              </div>
            </div>
          ...
          <div class="w-full h-auto lg:pr-20 pr-0 container mx-auto flex lg:flex-row flex-col-reverse justify-between lg:py-8 py-4 mt-4">
            ...
            <div class="lg:w-1/2 w-full h-auto lg:pl-24 px-4 lg:pr-0 py-6">
              <h1 class="text-mont text-black-50 lg:text-3xl text-2xl font-bold mt-8 lg:mt-0">
                Searching for inspiration?
              </h1>
              <p class="text-gray-600 text-mont text-xl mt-4">
              ...
              <p class="text-black-50 text-mont text-sm p-4 rounded-xl border border-lgray mt-4">
          ...
          <div class="w-full h-auto mt-4 mb-8 p-6 container mx-auto flex flex-col items-center">
            <h2 class="text-blue text-mont lg:text-2xl text-xl font-bold flex items-center">
            ...
            <button class="lg:w-1/6 w-full text-white text-mont text-xs font-bold rounded-lg text-center px-8 py-4 mt-4 bg-sblue">
              DONATE NOW
            </button>
            <h3 class="text-lg text-mont text-black-50 font-bold mt-4">
              Still waiting…?
            </h3>
          </div>
        </section>
